 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */if(th.classList.contains("btnIn")){e.preventDefault();const s=Zl.value,r=eh.value,o=(await(t=ih,n=s,i=r,$c(Xe(t),Ac.credential(n,i))),ih.currentUser.uid);await ea(Go(sh,"/users/"+o),(e=>{const t=e.val().name;localStorage.setItem("name",t)}),{onlyOnce:!0})}}));
//# sourceMappingURL=index.b8c6f852.js.map
