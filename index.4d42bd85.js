 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let qe;We.EMPTY_NODE=new class{copy(e,t,n,i,r){return this}insert(e,t,n){return new ze(e,t,null)}remove(e,t){return this}count(){return 0}isEmpty(){return!0}inorderTraversal(e){return!1}reverseTraversal(e){return!1}minKey(){return null}maxKey(){return null}check_(){return 0}isRed_(){return!1}};const je=function(e){return"number"==typeof e?"number:"+z(e):"string:"+e},He=function(e){if(e.isLeafNode()){const t=e.val();(0,o.assert)("string"==typeof t||"number"==typeof t||"object"==typeof t&&(0,o.contains)(t,".sv"),"Priority must be a string or number.")}else(0,o.assert)(e===qe||e.isEmpty(),"priority of unexpected type.");(0,o.assert)(e===qe||e.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qt{constructor(e){this.writeTree_=e}static empty(){return new qt(new Bt(null))}}function jt(e,t,n){if(xe(t))return new qt(new Bt(n));{const i=e.writeTree_.findRootMostValueAndPath(t);if(null!=i){const r=i.path;let s=i.value;const o=ke(r,t);return s=s.updateChild(o,n),new qt(e.writeTree_.set(r,s))}{const i=new Bt(n),r=e.writeTree_.setTree(t,i);return new qt(r)}}}function Ht(e,t,n){let i=e;return F(n,((e,n)=>{i=jt(i,we(t,e),n)})),i}function Vt(e,t){if(xe(t))return qt.empty();{const n=e.writeTree_.setTree(t,new Bt(null));return new qt(n)}}function $t(e,t){return null!=Xt(e,t)}function Xt(e,t){const n=e.writeTree_.findRootMostValueAndPath(t);return null!=n?e.writeTree_.get(n.path).getChild(ke(n.path,t)):null}function Kt(e){const t=[],n=e.writeTree_.value;return null!=n?n.isLeafNode()||n.forEachChild(Ge,((e,n)=>{t.push(new Ae(e,n))})):e.writeTree_.children.inorderTraversal(((e,n)=>{null!=n.value&&t.push(new Ae(e,n.value))})),t}function Gt(e,t){if(xe(t))return e;{const n=Xt(e,t);return new qt(null!=n?new Bt(n):e.writeTree_.subtree(t))}}function Yt(e){return e.writeTree_.isEmpty()}function Jt(e,t){return Qt(fe(),e.writeTree_,t)}function Qt(e,t,n){if(null!=t.value)return n.updateChild(e,t.value);{let i=null;return t.children.inorderTraversal(((t,r)=>{".priority"===t?((0,o.assert)(null!==r.value,"Priority writes must always be leaf nodes"),i=r.value):n=Qt(we(e,t),r,n)})),n.getChild(e).isEmpty()||null===i||(n=n.updateChild(we(e,".priority"),i)),n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let jn=1;class Hn{constructor(e){this.listenProvider_=e,this.syncPointTree_=new Bt(null),this.pendingWriteTree_={visibleWrites:qt.empty(),allWrites:[],lastWriteId:-1},this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Vn(e,t,n,i,r){return function(e,t,n,i,r){(0,o.assert)(i>e.lastWriteId,"Stacking an older write on top of newer ones"),void 0===r&&(r=!0),e.allWrites.push({path:t,snap:n,writeId:i,visible:r}),r&&(e.visibleWrites=jt(e.visibleWrites,t,n)),e.lastWriteId=i}(e.pendingWriteTree_,t,n,i,r),r?Qn(e,new Rt({fromUser:!0,fromServer:!1,queryId:null,tagged:!1},t,n)):[]}function $n(e,t,n=!1){const i=function(e,t){for(let n=0;n<e.allWrites.length;n++){const i=e.allWrites[n];if(i.writeId===t)return i}return null}(e.pendingWriteTree_,t);if(en(e.pendingWriteTree_,t)){let t=new Bt(null);return null!=i.snap?t=t.set(fe(),!0):F(i.children,(e=>{t=t.set(new pe(e),!0)})),Qn(e,new Et(i.path,t,n))}return[]}function Xn(e,t,n){return Qn(e,new Rt({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,n))}function Kn(e,t,n,i,r=!1){const s=t._path,o=e.syncPointTree_.get(s);let a=[];if(o&&("default"===t._queryIdentifier||Un(o,t))){const l=Mn(o,t,n,i);0===o.views.size&&(e.syncPointTree_=e.syncPointTree_.remove(s));const c=l.removed;if(a=l.events,!r){const n=-1!==c.findIndex((e=>e._queryParams.loadsAllData())),r=e.syncPointTree_.findOnPath(s,((e,t)=>Bn(t)));if(n&&!r){const t=e.syncPointTree_.subtree(s);if(!t.isEmpty()){const n=function(e){return e.fold(((e,t,n)=>{if(t&&Bn(t)){return[qn(t)]}{let e=[];return t&&(e=Fn(t)),F(n,((t,n)=>{e=e.concat(n)})),e}}))}(t);for(let t=0;t<n.length;++t){const i=n[t],r=i.query,s=ti(e,i);e.listenProvider_.startListening(ai(r),ni(e,r),s.hashFn,s.onComplete)}}}if(!r&&c.length>0&&!i)if(n){const n=null;e.listenProvider_.stopListening(ai(t),n)}else c.forEach((t=>{const n=e.queryToTagMap.get(ii(t));e.listenProvider_.stopListening(ai(t),n)}))}!function(e,t){for(let n=0;n<t.length;++n){const i=t[n];if(!i._queryParams.loadsAllData()){const t=ii(i),n=e.queryToTagMap.get(t);e.queryToTagMap.delete(t),e.tagToQueryMap.delete(n)}}}(e,c)}return a}function Gn(e,t,n,i){const r=ri(e,i);if(null!=r){const i=si(r),s=i.path,o=i.queryId,a=ke(s,t);return oi(e,s,new Rt(Nt(o),a,n))}return[]}function Yn(e,t,n,i=!1){const r=t._path;let s=null,a=!1;e.syncPointTree_.foreachOnPath(r,((e,t)=>{const n=ke(e,r);s=s||zn(t,n),a=a||Bn(t)}));let l,c=e.syncPointTree_.get(r);if(c?(a=a||Bn(c),s=s||zn(c,fe())):(c=new An,e.syncPointTree_=e.syncPointTree_.set(r,c)),null!=s)l=!0;else{l=!1,s=it.EMPTY_NODE;e.syncPointTree_.subtree(r).foreachChild(((e,t)=>{const n=zn(t,fe());n&&(s=s.updateImmediateChild(e,n))}))}const u=Un(c,t);if(!u&&!t._queryParams.loadsAllData()){const n=ii(t);(0,o.assert)(!e.queryToTagMap.has(n),"View does not exist, but we have a tag");const i=jn++;e.queryToTagMap.set(n,i),e.tagToQueryMap.set(i,n)}let h=On(c,t,n,Zt(e.pendingWriteTree_,r),s,l);if(!u&&!a&&!i){const n=Wn(c,t);h=h.concat(function(e,t,n){const i=t._path,r=ni(e,t),s=ti(e,n),a=e.listenProvider_.startListening(ai(t),r,s.hashFn,s.onComplete),l=e.syncPointTree_.subtree(i);if(r)(0,o.assert)(!Bn(l.value),"If we're adding a query, it shouldn't be shadowed");else{const t=l.fold(((e,t,n)=>{if(!xe(e)&&t&&Bn(t))return[qn(t).query];{let e=[];return t&&(e=e.concat(Fn(t).map((e=>e.query)))),F(n,((t,n)=>{e=e.concat(n)})),e}}));for(let n=0;n<t.length;++n){const i=t[n];e.listenProvider_.stopListening(ai(i),ni(e,i))}}return a}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Oi{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Mi(e,t){let n=null;for(let i=0;i<t.length;i++){const r=t[i],s=r.getPath();null===n||Ce(s,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:s}),n.events.push(r)}n&&e.eventLists_.push(n)}function Fi(e,t,n){Mi(e,n),Wi(e,(e=>Ce(e,t)))}function zi(e,t,n){Mi(e,n),Wi(e,(e=>Ie(e,t)||Ie(t,e)))}function Wi(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const r=e.eventLists_[i];if(r){t(r.path)?(Ui(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function Ui(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();w&&C("event: "+n.toString()),B(i)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Bt=new C(3e4,6e4);function qt(){const e=st().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}let jt=null;function Ht(e){return jt=jt||function(e){return new Promise(((t,n)=>{var i,r,s;function o(){qt(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{qt(),n(m(e,"network-request-failed"))},timeout:Bt.get()})}if(null===(r=null===(i=st().gapi)||void 0===i?void 0:i.iframes)||void 0===r?void 0:r.Iframe)t(gapi.iframes.getContext());else{if(!(null===(s=st().gapi)||void 0===s?void 0:s.load)){const t=pe("iframefcb");return st()[t]=()=>{gapi.load?o():n(m(e,"network-request-failed"))},de(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>n(e)))}o()}})).catch((e=>{throw jt=null,e}))}(e),jt}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
...
//# sourceMappingURL=index.4d42bd85.js.map
